...
<td>感謝 APIKEY.FUN 贊助了本專案！<a href="https://apikey.fan/register?aff=SUB2API">APIKEY.FUN</a> 是 sub2api 開源專案的核心貢獻者之一，致力於提供開放、穩定、高性價比的 AI API 接入服務。平臺支援 Claude、OpenAI、Gemini 等熱門模型的 API 中轉服務，價格低至官方原價的 7%。通過專屬連結 <a href="https://apikey.fan/register?aff=SUB2API">APIKEY</a> 註冊，可享受充值最高 95 折優惠。</td>
</tr>
